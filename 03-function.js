...
//Type 1: Function with no argument or no parameter and no return value
function test() {
    console.log("Test");
    
}

test(); //Function Invocation or function call
...
var returnValue = addition(39.34, 65.98, 15436, 567);
console.log(`Addition is : ${returnValue}`);
