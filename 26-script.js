...
console.log("=====querySelectorAll() DOM API using element classes ======");
...
subtraction.addEventListener('click', ()=>{
    const numSubOne = +document.querySelector("#inputFiledOne").value;
    const numSubTwo = +document.querySelector("#inputFiledTwo").value;
    alert(numSubOne-numSubTwo);
});
